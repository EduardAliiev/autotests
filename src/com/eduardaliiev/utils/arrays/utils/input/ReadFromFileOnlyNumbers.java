...
public class ReadFromFile extends ReaderAndWriterPath {


    public StringBuilder readFromFile(String inputPath)
            throws IOException {
        ReadFromFile.inputPath = inputPath;             //передаем путь для чтения с файла
