package com.eduardaliiev.app.equerestdraftproject.draft.uploadproject;
 ...
 */
public class UploadImagesToGalleryInProject {
    FirefoxDriver driver;
    String baseUrl = "https://dev.equerestdraftproject.com/";
    ...
    //private final static String UPLOADGALLERY = "src/main/java/com/eduardaliiev/app/arrays/equerestdraftproject/resources/template.jpg";
    ...
    public void editAndSaveStandardProjectField() {
        ...
        upload.sendKeys("src/main/java/com/eduardaliiev/app/arrays/equerestdraftproject/resources/template.jpg");
