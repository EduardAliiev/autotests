...
// in practice difference between sorting methods is time, but we will use earthier solution
    ...
    private static final String INPUT_DATA = "src/test/java/com/eduardaliiev/app/resources/input.txt";
    private static final String EXPECTED_RESULTS = "src/test/java/com/eduardaliiev/app/resources/expected.txt";
